import Prescription from "../respositories/PrescriptionRepository.js";
...
const generatePrescriptionFile = async (prescription) => {
    ...
    const filePath = "./MediApp/prescriptions/${id}.pdf" + id + ".pdf";
    ...
    const recipe = "Medice: " + prescription.medicine;
